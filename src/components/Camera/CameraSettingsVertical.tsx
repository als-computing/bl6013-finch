...
type CameraSettingsVerticalProps = {
...
export default function CameraSettingsVertical({enableSettings=true, settings=[], prefix='13SIM1:cam1', cameraSettingsPVs={}, onSubmit=()=>{}, styles}: CameraSettingsVerticalProps) {
    if (enableSettings) {
        return (
